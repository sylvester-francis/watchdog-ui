...
<a
  ...
  data-size={size}
  data-tone={tone}
  class="inline-flex items-center justify-center font-medium no-underline transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background {tone ? toneClasses[tone] : variantClasses[variant]} {sizeClasses[size]}"
>
  {@render children?.()}
</a>
